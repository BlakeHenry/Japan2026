...
// formatStay / formatWindow / formatHours and the whole-trip calendar
// (buildTripCalendar and its TripDay / CalendarBand / CalendarFloat types)
// used to live here. They existed for the /overview/ spreadsheet, which the
// editable timeline replaced — the timeline works in day offsets from the trip
// window and formats its own labels in src/components/plan/DetailPane.tsx.
// Nothing here formats a stay any more; `git log` has them if a paper view
// ever comes back.
